...
# The dispatcher-level tests lived here. go_where_pointed was removed at the
# operator's request, so they went with it; the geometry above is still used
# by the follow code and stays covered.
